...
- generic [active] [ref=f16e1]:
  - paragraph [ref=f16e3]:
    ...
    - link "Development Tools" [ref=f16e5] [cursor=pointer]
  - banner [ref=f16e10]:
    ...
    - generic [ref=f16e41]:
      - insertion [ref=f16e43]:
        - generic [ref=f16e46]:
          ...
          - link "Software testing course" [ref=f16e49] [cursor=pointer]
          - link "Factory Automation" [ref=f16e54] [cursor=pointer]
          - link "Test case management" [ref=f16e59] [cursor=pointer]
          - link "Colleges & Universities" [ref=f16e64] [cursor=pointer]
          - link "Software Utilities" [ref=f16e69] [cursor=pointer]
          - link "UI testing examples" [ref=f16e74] [cursor=pointer]
          - link "Automation testing platform" [ref=f16e79] [cursor=pointer]
      ...
      - insertion [ref=f16e102]:
        - generic [ref=f16e105]:
          ...
          - link "Technical Reference" [ref=f16e108] [cursor=pointer]
          - link "Test automation tools" [ref=f16e113] [cursor=pointer]
          - link "Vocational & Continuing Education" [ref=f16e118] [cursor=pointer]
          - link "Test case templates" [ref=f16e123] [cursor=pointer]
          - link "Development Tools" [ref=f16e128] [cursor=pointer]
          - link "Internet & Telecom" [ref=f16e133] [cursor=pointer]
          - link "Free mock exams" [ref=f16e138] [cursor=pointer]
          - link "Login security audit" [ref=f16e143] [cursor=pointer]
...
```ts
  ...
  24 |     expect(page.url()).toBe(`${process.env.BASE_URL}/secure`);
  25 |   });
  26 | 
